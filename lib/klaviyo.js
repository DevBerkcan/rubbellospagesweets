...
async function getProfileByEmail(email) {
  ...
  const url = `${KLAVIYO_API_BASE}/profiles/?filter=${encodeURIComponent(emailFilter)}`;
...
async function upsertProfile({
  ...
  if (newCode) {
    ...
    if (existingProfile && existingProfile.attributes && existingProfile.attributes.properties) {
